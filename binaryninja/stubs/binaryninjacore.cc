...
BINARYNINJACOREAPI const bool BNBasicBlockHasInstructionData(
    BNBasicBlock* block) {
  return {};
}
BINARYNINJACOREAPI const uint8_t* BNBasicBlockGetInstructionData(
    BNBasicBlock* block, uint64_t addr, size_t* len) {
  return {};
}
BINARYNINJACOREAPI void BNBasicBlockAddInstructionData(BNBasicBlock* block,
                                                       const void* data,
                                                       size_t len) {}
...
BINARYNINJACOREAPI BNDemanglerConfig BNGetDemanglerConfigForBinaryView(
    BNBinaryView* view) {
  return {};
}
...
BINARYNINJACOREAPI bool BNDemangleWithDemangler(
    const BNDemangler* demangler, const char* name,
...
BINARYNINJACOREAPI void BNAppendSymbolQueueWork(
    BNSymbolQueue* queue, BNSymbolQueueWorkCallbacks* callbacks) {}
