...
if(TARGET absl::core_headers)
  ...
  if(MSVC)
    set(ABSL_MSVC_STATIC_RUNTIME ${BINEXPORT_MSVC_STATIC_RUNTIME} CACHE BOOL "" FORCE)
  endif()
  if(BUILD_TESTING AND BINEXPORT_BUILD_TESTING)
...
if(MSVC)
  set(protobuf_MSVC_STATIC_RUNTIME ${BINEXPORT_MSVC_STATIC_RUNTIME} CACHE BOOL "" FORCE)
endif()
